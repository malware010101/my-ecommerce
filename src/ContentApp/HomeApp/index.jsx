 ...
 const hndlConfirmDelete = async () => {
    ...
    return (
        <Container maxWidth="lg">
            ...
            <Typography fontSize={{ xs: '.7rem', md: '1rem' }}  textAlign={'left'} padding={'10px'} fontStyle={'italic'} color={'#bbb'}>Aqui encontraras programas de entrenamiento para diferentes objetivos, niveles, fuerza e intensidad, clases de abdomen, clases funcionales, entrenamientos metabolicos, videos y mucho mas.<br></br><br></br> Responde el <strong>cuestionario </strong>en tu seccion de <strong>MI ENTRENAMIENTO</strong>, para que nuestro equipo de atletas lo evalue y te asigne un plan de entrenamiento adecuado para ti y si el programa asignado no se adapta a tu objetivos, puedes cambiarlo en calquier momento o solicitar ayuda en nuestro chat para asignarte el programa que se adapte mejor a tus necesidades. <br></br>Cada programa es parte de un macrociclo de entrenamiento y a sido desarrollado a base de fundamentos biomecanicos, años de experiencia y estudios. Seguiremos actulizando programas, clases y contenido para ti.<br></br><br></br>Acompaña tu entrenamiento con tu plan alimenticio en la seccion de <strong>MI NUTRICION</strong> para obtener los mejores resultados.<br></br> <br></br>En caso de ser usuario de suscripcion <strong>PRO</strong>, tendras la opcion de solicitar un programa de entrenamiento personalizado <strong>EXCLUSIVO </strong> para ti, adaptado a tus objetivos y preferencias segun tu anamnesis.</Typography>
            </Box>
